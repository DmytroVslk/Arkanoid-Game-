...
public class Arkanoid {
    ...
    // run() — main game loop: processes input, updates game, renders canvas
    ...
    // checkBricksBump() — removes brick if hit, changes ball direction
    ...
    // checkStandBump() — reflects ball off the paddle
    void checkStandBump() {
    ...
    // checkEndGame() — ends game if ball falls below the paddle
    void checkEndGame() {
